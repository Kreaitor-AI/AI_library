...
class StabilityImageEditor:
    ...
    def search_replace(self, image_bytes: bytes, prompt: str, search_prompt: str, output_format: str = "png") -> bytes:
        """
...
def search_replace(api_key: str, aws_access_key: str, aws_secret_key: str, bucket_name: str, image_bytes: bytes, prompt: str, search_prompt: str, output_format: str = "png") -> str:
    """
    ...
    edited_image_content = editor.search_replace(image_bytes, prompt, search_prompt, output_format)
