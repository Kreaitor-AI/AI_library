...
class StabilityImageGenerator:
    ...
    def inpaint(self, image_bytes: bytes, mask_bytes: bytes, prompt: str, output_format: str = "png") -> bytes:
        """
        Perform inpainting using the Stability AI API.

        Args:
            image_bytes (bytes): The binary content of the image to inpaint.
            mask_bytes (bytes): The binary content of the mask image.
...
def inpaint(api_key: str, aws_access_key: str, aws_secret_key: str, bucket_name: str, image_bytes: bytes, mask_bytes: bytes, prompt: str) -> str:
    """
    ...
    Args:
        ...
        image_bytes (bytes): The binary content of the image to be inpainted.
        mask_bytes (bytes): The binary content of the mask image.
        prompt (str): The prompt to guide the inpainting process.
    ...
    image_content = generator.inpaint(image_bytes=image_bytes, mask_bytes=mask_bytes, prompt=prompt)
