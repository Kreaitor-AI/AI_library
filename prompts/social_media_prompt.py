...
def social_media_prompt(query, summary, socialmedia, post_topic, sub_topic, tone, words):
    ...
    Args:
        ...
        post_topic (str): The type of post (e.g., Ad, BrandPromotionPost, etc.).
    ...
    # Retrieve the content based on the social media and post types
    ...
    # Get the content dictionary for the selected social media
    content_dict = social_media_content.get(socialmedia, {})
    
    # Get the specific post content based on the topic and sub-topic
    post_content = content_dict.get(post_topic, {}).get(sub_topic, "Default Content")  # Fallback if not found
