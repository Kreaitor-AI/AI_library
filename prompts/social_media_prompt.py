...
SocialMedia = {
    "Post": {
        "Normal": "Craft posts that resonate with the general audience by using a conversational tone. Content should be relevant to current trends and events while reflecting your brand's core message. Engage the audience with questions or calls to action to encourage interactions such as likes, comments, and shares.",
        "Celebration": "Use these posts to highlight company milestones, cultural or festive celebrations. Emphasize the joy and positivity associated with the occasion. Content should be vibrant and celebratory, acknowledging either communal occasions or internal achievements with a sense of shared pride and gratitude.",
        "Nostalgic": "Invoke feelings of nostalgia by sharing content from the past that connects emotionally with your audience. This could include company achievements, historical product launches, or popular trends from the past. The tone should be sentimental and evocative, aimed at creating a bond through shared memories and experiences."
    },
    "Ad": {
        "Children": "Advertisements aimed at children should be colorful and lively, focusing on animation or cartoon characters if appropriate. Language should be simple, clear, and direct, emphasizing fun and educational value. It’s crucial to ensure all content is safe and appropriate for children.",
        "Teens": "Ads targeting teens should tap into current trends, slang, and pop culture that are relevant to the youth. Promote products by highlighting their social appeal and cool factor. Use a casual and engaging tone, and consider channels and formats popular among teenagers, like short videos and interactive content.",
        "Male": "Focus on ads that appeal to interests commonly associated with males, depending on your product or service. This could include emphasizing aspects like durability, technology, and performance. Use strong, assertive language and highlight the practical benefits of the product.",
        "Females": "Create ads that speak to women by focusing on empowerment, design, and functionality. Highlight how the product fits into a busy lifestyle or offers solutions to specific problems. Use an empathetic and supportive tone, and ensure visuals represent a diverse range of women."
    },
    "Marketing": {
        "Direct": "Utilize a straightforward approach to explain the product or service benefits clearly and concisely. Direct marketing should focus on presenting information that leads to immediate actions, such as sales or sign-ups, and include strong calls to action.",
        "Influencer": "Collaborate with influencers who resonate with your target audience to create authentic and trusted content. The approach should be personalized and feel organic to the influencer’s typical content to maintain credibility. Influencer campaigns should align with both the brand’s and the influencer’s image and values.",
        "Referral": "Encourage current customers to refer new ones by offering incentives. The referral program should be easy to use and beneficial for both the referrer and the referee. Focus on creating a seamless sharing experience through social media or digital platforms."
    },
    "Titles": {
        "Direct": "Use clear, unambiguous language that directly relates to the content or message of the post. Titles should be attention-grabbing and convey the core message or offer upfront, suitable for promotions and announcements.",
        "Indirect": "Craft titles that pique curiosity without immediately revealing the full context. These titles should intrigue the reader to explore the content further, ideal for storytelling or content designed to create engagement through intrigue."
    },
    "Products": {
        "Description": "Provide a detailed and engaging description of the product that highlights key features and benefits. Use persuasive language to showcase how the product stands out from competitors and fits into the potential customer's lifestyle or solves a particular problem. Descriptions should be comprehensive yet easy to read, with bullet points or short paragraphs to enhance readability."
    }
}
...
def social_media_prompt(query, summary, post, socialmedia, tone, words):
    ...
    Args:
        ...
        post (str): The type of post (e.g., News, Marketing, etc.).
