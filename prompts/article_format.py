...
2. Provide relevant detailed prompts for each image. Insert images at appropriate places/sections in the article using FORMAT: [Image i: image prompt], where i is the img_number.
...
Format the content accordingly. Don't start with 'Here is the formatted essay content:'. Directly start with the article.
"""
